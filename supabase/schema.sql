...
CREATE TABLE IF NOT EXISTS public.user_sessions (
    ...
    device_model   text,
    os_version     text,
    trial          integer NOT NULL DEFAULT 2,
    last_active_at timestamptz NOT NULL DEFAULT now(),
    updated_at     timestamptz NOT NULL DEFAULT now()
);

-- public.device_history (Device binding and change audit trail)
...
-- Secure RPC: admin_reset_user_device
...
-- 11.2 User sessions & device history policies
